  ...
  return (
   ...
   <div
        ...
        >
          <Image
            className="aboutimg"
            src="https://images.unsplash.com/photo-1754763679553-e7afebe65d44?q=80&w=1171&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="About Image"
            width={800}
            height={400}
            priority
        ...
        <div className="col-12 col-md-6 col-lg-7 abouttext" data-aos="fade-left">
          <h2> About Us meeeeeeeeeeee <iconify-icon icon="material-symbols:bolt-outline"></iconify-icon></h2>
          <p>
